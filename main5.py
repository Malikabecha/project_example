...
state_level_analysis = dbc.Container([
            ...
            dbc.Row([  dbc.Col([ dcc.Graph(id="fig_1_state",figure =fig_1_state ,  style={'display': 'inline-block'}) ,  ]) , dbc.Col([  html.Br() , html.Br() , html.Br() , dbc.Table.from_dataframe(   yoy_homeless, striped=False, bordered=True, hover=True, index=True , size = 'lg'), ]  ) ,        ]),
